...
const projects = [
  ...
  { id: '2', title: 'Library System project', summary: 'The Library System project is a project that aims to create a library system that can manage the books and the users in the library.' },
];
